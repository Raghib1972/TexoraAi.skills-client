          ...
          {step === 3 && (
            <div className="space-y-5">
              ...
              <div className={`p-4 rounded-lg space-y-2 transition-all duration-300 ${
                ...
                }`}><strong>Name:</strong> {formData.fullName || "—"}</p>
                <p className={`transition-colors duration-300 ${
                  darkMode ? "text-gray-200" : "text-gray-800"
                ...
                <p className={`transition-colors duration-300 ${
                  darkMode ? "text-gray-200" : "text-gray-800"
                }`}><strong>Admin Type:</strong> {formData.adminType || "—"}</p>
                <p className={`transition-colors duration-300 ${
                  darkMode ? "text-gray-200" : "text-gray-800"
                }`}><strong>Department:</strong> {formData.department || "—"}</p>
                <p className={`transition-colors duration-300 ${
                  darkMode ? "text-gray-200" : "text-gray-800"
                }`}><strong>Location:</strong> {formData.cityState || "—"}</p>
                <p className={`transition-colors duration-300 ${
                  darkMode ? "text-gray-200" : "text-gray-800"
                }`}><strong>Employee ID:</strong> {formData.employeeId || "—"}</p>
              </div>
